...
namespace Recovery.FileSystem.Hikvision
{
    ...
    {
        //000h: 00 00 -- -- -- -- -- --   -- -- -- -- -- -- -- --
        private short _unknown0;

        //000h: -- -- 00 00 00 00 00 00   00 00 00 00 00 -- -- --
        ...
        private long _dataBlockStartOffset;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 480)]
        private byte[] unknown_20h;
        ...
        public long DataBlockStartOffset { get { return _dataBlockStartOffset; } }
        ...
        public bool CanRead
        {
            ...
            {
                int sum = 0;
                for (int i = 0; i < _zero1.Length; i++)
                {
                    sum += _zero1[i];
                }
                for (int i = 0; i < _zero2.Length; i++)
                {
                    sum += _zero2[i];
                }
